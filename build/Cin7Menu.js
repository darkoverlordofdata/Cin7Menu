...
(function() {
  ...
  ApplicationContextMenuItem = (function() {
    ...
    ApplicationContextMenuItem.prototype.__proto__ = base = PopupMenu.PopupBaseMenuItem.prototype;
    ...
    ApplicationContextMenuItem.prototype.activate = function(event) {
      var desktopFiles, destFile, e, enabled_applets, file, new_applet_id, settings, winListApplet;
      switch (this._action) {
        case 'add_to_panel':
          winListApplet = false;
          try {
  ...
  GenericApplicationButton = (function() {
    ...
    GenericApplicationButton.prototype.__proto__ = base = PopupMenu.PopupSubMenuMenuItem.prototype;

    function GenericApplicationButton(appsMenuButton, app) {
      this._init(appsMenuButton, app);
    }

    GenericApplicationButton.prototype._init = function(appsMenuButton, app) {
      this.app = app;
    ...
    GenericApplicationButton.prototype.toggleMenu = function() {
      var child, children, menuItem, _i, _len;
      if (!this.withMenu) {
        return;
      }
      if (!this.menu.isOpen) {
  ...
  TransientButton = (function() {
    ...
    TransientButton.prototype.__proto__ = base = AppPopupSubMenuMenuItem.prototype;
    ...
    TransientButton.prototype._init = function(appsMenuButton, pathOrCommand) {
      var contentType, displayPath, e, fileInfo, iconBox, iconName, icon_uri, n, themedIcon;
  ...
  ApplicationButton = (function() {
    ...
    ApplicationButton.prototype.__proto__ = base = GenericApplicationButton.prototype;
  ...
  PlaceButton = (function() {
    ...
    PlaceButton.prototype.__proto__ = base = PopupMenu.PopupBaseMenuItem.prototype;
  ...
  RecentButton = (function() {
    ...
    RecentButton.prototype.__proto__ = base = PopupMenu.PopupBaseMenuItem.prototype;
  ...
  RecentClearButton = (function() {
    ...
    RecentClearButton.prototype.__proto__ = base = PopupMenu.PopupBaseMenuItem.prototype;
  ...
  CategoryButton = (function() {
    ...
    CategoryButton.prototype.__proto__ = base = PopupMenu.PopupBaseMenuItem.prototype;
  ...
  PlaceCategoryButton = (function() {
    ...
    PlaceCategoryButton.prototype.__proto__ = base = PopupMenu.PopupBaseMenuItem.prototype;
  ...
  RecentCategoryButton = (function() {
    ...
    RecentCategoryButton.prototype.__proto__ = base = PopupMenu.PopupBaseMenuItem.prototype;
  ...
  FavoritesButton = (function() {
    ...
    FavoritesButton.prototype.__proto__ = base = GenericApplicationButton.prototype;
  ...
  AppPopupSubMenuMenuItem = (function() {
    ...
    AppPopupSubMenuMenuItem.prototype.__proto__ = base = PopupMenu.PopupBaseMenuItem.prototype;

    constructor(text, hide_expander)(function() {
      return this._init(text, hide_expander);
    });
    ...
    AppPopupSubMenuMenuItem.prototype.destroy = function() {
      this.menu.destroy();
      return PopupBaseMenuItem.prototype.destroy.call(this);
    };
  ...
  TextBoxItem = (function() {
    ...
    TextBoxItem.prototype.__proto__ = base = AppPopupSubMenuMenuItem.prototype;
  ...
  AllProgramsItem = (function() {
    ...
    AllProgramsItem.prototype.__proto__ = base = AppPopupSubMenuMenuItem.prototype;

    function AllProgramsItem(label, icon, parent) {
      this._init(label, icon, parent);
    }

    _init(label, icon, parent)(function() {
      base._init.call(this, label);
  ...
  ShutdownContextMenuItem = (function() {
    ...
    ShutdownContextMenuItem.prototype.__proto__ = base = ApplicationContextMenuItem.prototype;
  ...
  ShutdownMenu = (function() {
    ...
    ShutdownMenu.prototype.__proto__ = base = AppPopupSubMenuMenuItem.prototype;

    function ShutdownMenu(parent, hoverIcon) {
      this._init(parent, hoverIcon);
    }

    _init(parent, hoverIcon)(function() {
      var label, menuItem;
      label = '';
      this.hoverIcon = hoverIcon;
      this.parent = parent;
  ...
  RightButtonsBox = (function() {
    ...
    RightButtonsBox.prototype.addItems = function() {
      var i, link, screensaver_dialog, screensaver_settings, split, _i, _len, _ref, _results;
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        if (link !== '') {
          ...
          this.shutDownMenuBox.set_style('min-height: 82px');
          _results.push(this.itemsBox.add_actor(this.shutDownIconBox));
        } else {
    ...
    RightButtonsBox.prototype._getPreferredHeight = function(actor, forWidth, alloc) {
      var minSize, naturalSize, _ref;
      _ref = this.itemsBox.get_preferred_height(forWidth), minSize = _ref[0], naturalSize = _ref[1];
    ...
    RightButtonsBox.prototype._getPreferredWidth = function(actor, forHeight, alloc) {
      var minSize, naturalSize, _ref;
      _ref = this.itemsBox.get_preferred_width(forHeight), minSize = _ref[0], naturalSize = _ref[1];
      alloc.min_size = minSize;
      return alloc.natural_size = naturalSize;
    };

    RightButtonsBox.prototype._allocate = function(actor, box, flags) {
      var childBox, mainBoxHeight, minHeight, minWidth, naturalHeight, naturalWidth, _ref;
      childBox = new Clutter.ActorBox();
      _ref = this.itemsBox.get_preferred_size(), minWidth = _ref[0], minHeight = _ref[1], naturalWidth = _ref[2], naturalHeight = _ref[3];
      childBox.y1 = 0;
  ...
  FavoritesBox = (function() {
    ...
    FavoritesBox.prototype.handleDragOver = function(source, actor, x, y, time) {
      var app, appChildren, boxHeight, children, fadeIn, favPos, favorites, numChildren, numFavorites, pos, srcIsFavorite, _ref;
      app = source.app;
      if (app === null || app.is_window_backed() || (!(source instanceof FavoritesButton) && (_ref = app.get_id(), __indexOf.call(AppFavorites.getAppFavorites().getFavoriteMap(), _ref) >= 0))) {
    ...
    FavoritesBox.prototype.acceptDrop = function(source, actor, x, y, time) {
      ...
      srcIsFavorite = (__indexOf.call(favorites, id) >= 0);
      favPos = 0;
      children = this.actor.get_children();
      i = 0;
      while (i < this._dragPlaceholderPos) {
        ...
        if (__indexOf.call(favorites, childId) >= 0) {
          favPos++;
        }
        i++;
      }
  ...
  MyApplet = (function() {
    ...
    MyApplet.prototype.__proto__ = base = Applet.TextIconApplet.prototype;
    ...
    MyApplet.prototype._addEnterEvent = function(button, callback) {
      ...
      _callback = (function(_this) {
        return function() {
          var parent, _maybePreviousActor;
    ...
    MyApplet.prototype._refreshApps = function() {
      var bookmarks, button, categoryButton, devices, dir, i, id, iter, nextType, place, places, root, tree, trees, _fn, _fn1, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref;
      ...
      for (i = _i = 0, _len = trees.length; _i < _len; i = ++_i) {
        tree = trees[i];
        ...
        _ref = this._applicationsButtons;
        ...
        if (this.showPlaces) {
          ...
          _fn = function(button) {
            ...
            return this.applicationsBox.add_actor(button.actor);
          };
          for (_k = 0, _len2 = places.length; _k < _len2; _k++) {
            place = places[_k];
            _fn(new PlaceButton(this, place, place.name));
          }
          this.placesButton.actor.connect('leave-event', (function(_this) {
            return function() {
              if (!_this.searchActive) {
          ...
          for (_l = 0, _len3 = places.length; _l < _len3; _l++) {
            place = places[_l];
            _fn1(new PlaceButton(this, place, place.name));
          }
        }
        if (this.showRecent) {
          ...
          while (id < MAX_RECENT_FILES && id < this.RecentManager._infosByTimestamp.length) {
            (function(button) {
              ...
              return this.applicationsBox.add_actor(button.actor);
            })(new RecentButton(this, this.RecentManager._infosByTimestamp[id++]));
          }
    ...
    MyApplet.prototype._refreshFavs = function() {
      var app, appSys, favoritesBox, launcher, launchers, _i, _len, _results;
      ...
      appSys = Cinnamon.AppSystem.get_default();
      _results = [];
      for (_i = 0, _len = launchers.length; _i < _len; _i++) {
        launcher = launchers[_i];
        ...
        if (app) {
          _results.push((function(button) {
            ...
            button.actor.connect('enter-event', (function(_this) {
              return function() {
            ...
            return button.actor.connect('leave-event', (function(_this) {
              return function() {
                _this.selectedAppTitle.set_text("");
                return _this.selectedAppDescription.set_text("");
              };
            })(this));
          })(new FavoritesButton(this, app, launchers.length, this.favorite_icon_size)));
        } else {
          _results.push(void 0);
        }
      }
    ...
    MyApplet.prototype._loadCategory = function(dir, top_dir) {
      var app, applicationButton, button, dupe, entry, iter, nextType, _i, _len, _ref, _results;
      iter = dir.iter();
      dupe = false;
      if (!top_dir) {
        top_dir = dir;
        ...
        if (nextType === CMenu.TreeItemType.ENTRY) {
          ...
          if (!entry.get_app_info().get_nodisplay()) {
            ...
            if (!dupe) {
              ...
              _results.push(this.applicationsByCategory[top_dir.get_menu_id()].push(app.get_name()));
            } else {
              _ref = this._applicationsButtons;
              for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                button = _ref[_i];
              ...
              _results.push(this.applicationsByCategory[dir.get_menu_id()].push(app.get_name()));
            }
          } else if (nextType === CMenu.TreeItemType.DIRECTORY) {
            this._previousSelectedActor = applicationButton.actor;
            applicationButton.actor.style_class = "menu-application-button";
            this.selectedAppTitle.set_text("");
            _results.push(this.selectedAppDescription.set_text(""));
          } else {
            _results.push(void 0);
          }
        } else {
    ...
    MyApplet.prototype._display = function() {
      ...
      this.applicationsByCategory = this._refreshApps();
    ...
    MyApplet.prototype._clearAllSelections = function() {
      var actor, actors, _i, _j, _len, _len1;
    ...
    MyApplet.prototype.closeApplicationsContextMenus = function(excludeApp, animate) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (app !== excludeApp && app.menu.isOpen) {
          if (animate) {
            _results.push(app.toggleMenu());
          } else {
            _results.push(app.closeMenu());
          }
        } else {
          _results.push(void 0);
        }
    ...
    MyApplet.prototype._displayButtons = function(appCategory, places, recent, apps, autocompletes) {
      var app, auto, button, innerapps, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2;
      innerapps = this.applicationsBox.get_children();
      for (_i = 0, _len = innerapps.length; _i < _len; _i++) {
        app = innerapps[_i];
        app.hide();
      }
      if (appCategory) {
      ...
      if (autocompletes) {
        for (_m = 0, _len4 = autocompletes.length; _m < _len4; _m++) {
          auto = autocompletes[_m];
    ...
    MyApplet.prototype._setCategoriesButtonActive = function(active) {
      var button, categoriesButtons, e, _i, _len;
      try {
        categoriesButtons = this.categoriesBox.get_children();
        for (_i = 0, _len = categoriesButtons.length; _i < _len; _i++) {
          button = categoriesButtons[_i];
          if (active) {
    ...
    MyApplet.prototype._listBookmarks = function(pattern) {
      var bookmark, bookmarks, res, _i, _len;
    ...
    MyApplet.prototype._listDevices = function(pattern) {
      var device, devices, res, _i, _len;
    ...
    MyApplet.prototype._listApplications = function(category_menu_id, pattern) {
      var app, applist, button, res, _i, _len, _ref;
      applist = new Array();
      if (category_menu_id) {
    ...
    MyApplet.prototype._doSearch = function() {
      var acResults, appResults, bookmark, bookmarks, button, device, devices, item_actor, pattern, placesResults, recentResults, _i, _j, _k, _len, _len1, _len2, _ref;
      ...
      _ref = this._recentButtons.length;
