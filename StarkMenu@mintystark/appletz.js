...
ApplicationContextMenuItem.prototype = {
    ...
    activate: function (event) {
        switch (this._action){
            case "add_to_panel":
                var winListAppvar = false;
                try {
                    winListAppvar = imports.ui.appletManager.applets['WindowListGroup@jake.phy@gmail.com'];
                } catch (e) {}
...
function main(metadata, orientation, panel_height, instance_id) {
    var myAppvar = new MyApplet(orientation, panel_height, instance_id);
    return myApplet;
}
