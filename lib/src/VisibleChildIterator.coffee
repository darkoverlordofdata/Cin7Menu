...
class VisibleChildIterator
  ...
  getFirstVisible:() -> @visible_children[0]

  getLastVisible:() -> @visible_children[@_num_children-1]

  getNumVisibleChildren:() -> @_num_children

  getAbsoluteIndexOfChild:() -> @abs_index[@visible_children.indexOf(child)]
